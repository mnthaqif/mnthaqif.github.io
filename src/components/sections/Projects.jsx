...
const Projects = () => {
  // Use hardcoded project data instead of fetching from GitHub
        ...
        {projects.length === 0 && (
          ...
          >
            ...
            <p className="text-slate-500 dark:text-slate-400 max-w-md">
              Add your projects to the projectsData.js file to display them here.
            </p>
          </motion.div>
        )}
        ...
        {projects.length > 0 && (
          ...
          >
            {projects.map((project) => {
              const displayLanguages = project.languages?.slice(0, 4) || [];
